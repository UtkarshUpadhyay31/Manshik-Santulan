...
import { Heart, Brain, ArrowRight, Menu, X, Activity, Phone, MessageSquare, Wind, Zap, Sun, ShieldAlert, ChevronRight, RefreshCw, Volume2, VolumeX, Users } from 'lucide-react';
import { Button, Container, Card } from '../components/UI';
import CrisisBreathing from '../components/CrisisBreathing';
...
const Help = () => {
    ...
    // Breathing state (Back by popular demand)
            ...
            <div className="min-h-screen bg-[#FDFCFB] text-slate-800 font-sans selection:bg-purple-100 selection:text-purple-900 overflow-x-hidden">
                ...
                <div className="relative z-10 pt-20 pb-10">
                    <Container>
                        ...
                        {panicActive && (
                            <div className="mb-16">
                                <CrisisBreathing onComplete={() => {/* Handle manual completion if needed */ }} />
                                <button onClick={() => setPanicActive(false)} className="mt-8 text-slate-500 underline font-medium block mx-auto">I'm feeling better now</button>
                            </div>
                        )}
